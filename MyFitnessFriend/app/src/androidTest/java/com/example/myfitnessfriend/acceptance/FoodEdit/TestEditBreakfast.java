...
public class TestEditBreakfast {
    ...
    public void testOnScreen(){
        ...
        onView(withId(R.id.totalBreakfastCalories)).check(matches(withText("0")));
        onView(withId(R.id.breakfastButton)).check(matches(isDisplayed()));
    }

    @Test
    public void testEditBreakfast(){
        ...
        //add first food
        onView(withId(R.id.breakfastButton)).perform(click());
        ...
        onView(withId(R.id.totalBreakfastCalories)).check(matches(withText("290")));
        ...
        onView(withId(R.id.addButton)).perform(click());
        onView(withId(R.id.totalBreakfastCalories)).check(matches(withText("580")));
