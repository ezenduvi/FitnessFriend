...
public class TestEditSnack {
    ...
    public void testOnScreen(){
        ...
        onView(withId(R.id.totalSnackCalories)).check(matches(withText("0")));
        onView(withId(R.id.snackButton)).check(matches(isDisplayed()));
    }

    @Test
    public void testEditSnack(){
        ...
        onView(withId(R.id.snackButton)).perform(click());
        ...
        onView(withId(R.id.totalSnackCalories)).check(matches(withText("290")));
        ...
        onView(withId(R.id.addButton)).perform(click());
        onView(withId(R.id.totalSnackCalories)).check(matches(withText("580")));
